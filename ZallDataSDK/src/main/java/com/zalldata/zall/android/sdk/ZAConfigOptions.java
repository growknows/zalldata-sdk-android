...
import com.zalldata.zall.android.sdk.encrypt.IPersistentSecretKey;
import com.zalldata.zall.android.sdk.encrypt.ZAEncryptListener;
import com.zalldata.zall.android.sdk.advert.utils.ChannelUtils;

import javax.net.ssl.SSLSocketFactory;

public final class ZAConfigOptions extends AbstractZAConfigOptions implements Cloneable {
    /**
     * 是否设置点击图开关
     */
     ...
     * 私有构造函数
     */
    private ZAConfigOptions() {
    }

    /**
     * 获取 ZAOptionsConfig 实例
     *
     * @param serverUrl，数据上报服务器地址
     */
    public ZAConfigOptions(String serverUrl) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setRemoteConfigUrl(String remoteConfigUrl) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setServerUrl(String serverUrl) {
        this.mServerUrl = serverUrl;
        return this;
    }
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setAutoTrackEventType(int autoTrackEventType) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions enableTrackAppCrash() {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setFlushInterval(int flushInterval) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setFlushBulkSize(int flushBulkSize) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setMaxCacheSize(long maxCacheSize) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setMinRequestInterval(int minRequestInterval) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setMaxRequestInterval(int maxRequestInterval) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions disableRandomTimeRequestRemoteConfig() {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions disableDebugAssistant() {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions enableHeatMap(boolean enableHeatMap) {
     ...
     */
    public ZAConfigOptions enableVisualizedProperties(boolean enableVisualizedProperties) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions enableVisualizedAutoTrack(boolean enableVisualizedAutoTrack) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions enableLog(boolean enableLog) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions enableTrackScreenOrientation(boolean enableScreenOrientation) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setNetworkTypePolicy(int networkTypePolicy) {
     ...
     * @return ZAOptionsConfig
     */
    public ZAConfigOptions setAnonymousId(String anonymousId) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions enableSaveDeepLinkInfo(boolean enableSave) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions setSourceChannels(String... channels) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions enableJavaScriptBridge(boolean isSupportJellyBean) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions enableAutoAddChannelCallbackEvent(boolean isAutoAddChannelCallbackEvent) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions enableEncrypt(boolean enableEncrypt) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions persistentSecretKey(IPersistentSecretKey persistentSecretKey) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions enableSubProcessFlushData() {
     ...
     */
    @Deprecated
    public ZAConfigOptions disableDataCollect() {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions setSSLSocketFactory(SSLSocketFactory SSLSocketFactory) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions enableTrackPush(boolean enableTrackPush) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions disableSDK(boolean disableSDK) {
     ...
     * @return ZAConfigOptions
     */
    public ZAConfigOptions enableTrackPageLeave(boolean isTrackPageLeave) {
    ...
    @Override
    protected ZAConfigOptions clone() {
        ZAConfigOptions copyObject = this;
        try {
            copyObject = (ZAConfigOptions) super.clone();
