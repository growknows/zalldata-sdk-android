...
package com.zalldata.zall.android.sdk.deeplink;
...
class ZallDataDeepLink extends AbsDeepLink {
    ...
    public ZallDataDeepLink(Intent intent, String serverUrl) {
        super(intent);
            ...
            new RequestHelper.Builder(HttpMethod.GET, getRequestUrl())
                    ...
                    .callback(new HttpCallback.JsonCallback() {
                        ...
                        public void onAfter() {
                            ...
                            if (mCallBack != null) {
                                mCallBack.onFinish(DeepLinkManager.DeepLinkType.ZALLDATA, pageParams, success, duration);
                            }
                            ZallDataAPI.sharedInstance().trackInternal("$AppDeeplinkMatchedResult", properties);
                        }
                    }).execute();
        }
    }
