...
package com.zalldata.zall.android.sdk.visual;
...
import com.zalldata.zall.android.sdk.util.Base64Coder;
import com.zalldata.zall.android.sdk.visual.model.SnapInfo;
import com.zalldata.zall.android.sdk.visual.model.WebNodeInfo;
import com.zalldata.zall.android.sdk.visual.property.VisualPropertiesManager;
import com.zalldata.zall.android.sdk.visual.snap.EditProtocol;
import com.zalldata.zall.android.sdk.visual.snap.EditState;
import com.zalldata.zall.android.sdk.visual.snap.ResourceIds;
import com.zalldata.zall.android.sdk.visual.snap.ResourceReader;
...
public abstract class AbstractViewCrawler implements com.zalldata.zall.android.sdk.visual.VTrack {
    ...
    AbstractViewCrawler(Activity activity, String resourcePackageName, String featureCode, String postUrl, String type) {
        ...
        final HandlerThread thread =
                new HandlerThread(com.zalldata.zall.android.sdk.visual.VisualizedAutoTrackViewCrawler.class.getCanonicalName(), Process.THREAD_PRIORITY_BACKGROUND);
        thread.start();
    ...
    private class ViewCrawlerHandler extends Handler {
        ...
        private com.zalldata.zall.android.sdk.visual.ViewSnapshot mSnapshot;
        ...
        private ViewCrawlerHandler(Context context, Looper looper, String resourcePackageName) {
            ...
            mSDKVersion = ZallDataAPI.sharedInstance().getSDKVersion();
        }
        ...
        private void sendSnapshot(JSONObject message) {
            ...
            try {
                ...
                if (null == mSnapshot) {
                    ZALog.i(TAG, "Snapshot should be initialize at first calling.");
                    return;
                }
            } catch (final JSONException e) {
                ZALog.i(TAG, "Payload with snapshot config required with snapshot request", e);
                return;
            } catch (final EditProtocol.BadInstructionsException e) {
                ZALog.i(TAG, "VisualizedAutoTrack server sent malformed message with snapshot request", e);
                return;
            }
            ...
            try {
                ...
                writer.write("\"app_enablevisualizedproperties\": " + ZallDataAPI.getConfigOptions().isVisualizedPropertiesEnabled() + ",");
                // 需要把全埋点的开关状态，透传给前端，前端进行错误提示
                try {
                    JSONArray array = new JSONArray();
                    if (!ZallDataAPI.sharedInstance().isAutoTrackEventTypeIgnored(ZallDataAPI.AutoTrackEventType.APP_CLICK)) {
                ...
                if (mUseGzip) {
                    ...
                    // 添加调试信息
                    String visualDebugInfo = com.zalldata.zall.android.sdk.visual.VisualizedAutoTrackService.getInstance().getDebugInfo();
                    ...
                    // 添加诊断信息日志
                    String visualLogInfo = com.zalldata.zall.android.sdk.visual.VisualizedAutoTrackService.getInstance().getVisualLogInfo();
                ...
                ZALog.i(TAG, "page_name： " + pageName);
                ...
                if (info.isWebView && !TextUtils.isEmpty(info.webViewUrl)) {
                    WebNodeInfo pageInfo = com.zalldata.zall.android.sdk.visual.WebNodesManager.getInstance().getWebPageInfo(info.webViewUrl);
                    if (pageInfo != null) {
                ...
                ZALog.i(TAG, "Can't write snapshot request to server", e);
            } finally {
                try {
                    if (os != null) {
                        os.close();
                ...
                try {
                    ...
                    ZALog.i(TAG, "Can't close payload_out.", e);
                }
                try {
                    writer.close();
                } catch (final IOException e) {
                    ZALog.i(TAG, "Can't close writer.", e);
                }
            }
            onSnapFinished(info);
            postSnapshot(out);
        ...
        private void onSnapFinished(SnapInfo info) {
            ...
            if (info != null && !com.zalldata.zall.android.sdk.visual.WebNodesManager.getInstance().hasWebView()) {
                com.zalldata.zall.android.sdk.visual.WebNodesManager.getInstance().clear();
            }
        }
        ...
        private void postSnapshot(ByteArrayOutputStream out) {
            ...
            try {
                ...
                if (responseCode == 200) {
                    ...
                    // 是否处于 debug = 1 状态
                    com.zalldata.zall.android.sdk.visual.VisualizedAutoTrackService.getInstance().setDebugModeEnabled(responseJson.optBoolean("visualized_debug_mode_enabled"));
                }
            } catch (Exception e) {
                ZALog.printStackTrace(e);
            } finally {
