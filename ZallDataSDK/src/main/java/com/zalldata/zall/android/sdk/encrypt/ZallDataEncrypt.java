...
package com.zalldata.zall.android.sdk.encrypt;
...
public class ZallDataEncrypt {
    ...
    private void saveLocalSecretKey(String key) {
        SharedPreferences preferences = ZallDataUtils.getSharedPreferences(mContext);
    ...
    private SecreteKey readAppKey() {
        ...
        ZALog.i(TAG, "readAppKey [key = " + publicKey + " ,v = " + keyVersion + " ,symmetricEncryptType = " + symmetricEncryptType + " ,asymmetricEncryptType = " + asymmetricEncryptType + "]");
    ...
    private SecreteKey readLocalKey() throws JSONException {
        ...
        String symmetricEncryptType = null;
        String asymmetricEncryptType = null;
        final SharedPreferences preferences = ZallDataUtils.getSharedPreferences(mContext);
        ...
        ZALog.i(TAG, "readLocalKey [key = " + publicKey + " ,v = " + keyVersion + " ,symmetricEncryptType = " + symmetricEncryptType + " ,asymmetricEncryptType = " + asymmetricEncryptType + "]");
        return new SecreteKey(publicKey, keyVersion, symmetricEncryptType, asymmetricEncryptType);
    }
