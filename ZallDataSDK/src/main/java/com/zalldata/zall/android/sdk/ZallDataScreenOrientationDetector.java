...
public class ZallDataScreenOrientationDetector extends OrientationEventListener {
    private int mCurrentOrientation;

    public ZallDataScreenOrientationDetector(Context context, int rate) {
        super(context, rate);
    }
