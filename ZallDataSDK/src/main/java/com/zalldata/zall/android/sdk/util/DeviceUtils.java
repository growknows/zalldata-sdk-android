...
public class DeviceUtils {
    ...
    public static String getHarmonyOSVersion() {
        ...
        if (isHarmonyOs()) {
            ...
            if(TextUtils.isEmpty(version)){
                version = exec(ZallDataUtils.COMMAND_HARMONYOS_VERSION);
            }
        }
        return version;
    }
    ...
    private static boolean isHarmonyOs() {
        try {
            ...
            ZALog.i("ZA.HasHarmonyOS", e.getMessage());
            return false;
        }
    }
    ...
    private static String getProp(String property, String defaultValue) {
        try {
            ...
            ZALog.i("ZA.SystemProperties", throwable.getMessage());
        }
        return defaultValue;
    }
