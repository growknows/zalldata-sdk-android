...
public class AppStateManager implements Application.ActivityLifecycleCallbacks {
    ...
    private static final String TAG = "ZA.AppStateManager";
        ...
        try {
            ...
            if (getParentFragmentMethod != null) {
                ...
                if (parentFragment == null) {
                    ...
                    ZALog.i(TAG, "setFragmentScreenName | " + fragmentScreenName + " is not nested fragment and set");
                } else {
                    ZALog.i(TAG, "setFragmentScreenName | " + fragmentScreenName + " is nested fragment and ignored");
                }
            }
        } catch (Exception e) {
            //ignored
