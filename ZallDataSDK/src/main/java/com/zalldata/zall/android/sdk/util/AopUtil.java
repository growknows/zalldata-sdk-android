...
import com.zalldata.zall.android.sdk.ZallDataFragmentTitle;
...
public class AopUtil {
    ...
    private static final String TAG = "ZA.AopUtil";
    @SuppressLint("NewApi")
        ...
        try {
            ...
            if (fragment instanceof ScreenAutoTracker) {
                ...
                if (trackProperties != null) {
                    ...
                    ZallDataUtils.mergeJSONObject(trackProperties, properties);
                }
            }
    ...
    public static JSONObject buildTitleAndScreenName(Activity activity) {
        ...
        try {
            ...
            if (activity instanceof ScreenAutoTracker) {
                ...
                JSONObject trackProperties = screenAutoTracker.getTrackProperties();
                if (trackProperties != null) {
                    ZallDataUtils.mergeJSONObject(trackProperties, propertyJSON);
                }
            }
        } catch (Exception ex) {
            com.zalldata.zall.android.sdk.ZALog.printStackTrace(ex);
    ...
    public static boolean isViewIgnored(Class viewType) {
        try {
            ...
            List<Class> mIgnoredViewTypeList = ZallDataAPI.sharedInstance().getIgnoredViewTypeList();
     ...
     * {@link ZallDataAPI#setViewProperties(View, JSONObject)} 低于
     * {@link ZallDataAPI#trackViewAppClick(View, JSONObject)}
     *
     * @param view 点击的 view
    ...
    public static boolean injectClickInfo(View view, JSONObject properties, boolean isFromUser) {
        ...
        try {
            ...
            if (activity != null) {
                ZallDataUtils.mergeJSONObject(AopUtil.buildTitleAndScreenName(activity), eventJson);
            }
    ...
    public static ViewNode addViewPathProperties(Activity activity, View view, JSONObject properties) {
        try {
            ...
            if ((ZallDataAPI.sharedInstance().isHeatMapEnabled() || ZallDataAPI.sharedInstance().isVisualizedAutoTrackEnabled())
                    && (ZallDataAPI.sharedInstance().isHeatMapActivity(activity.getClass()) || ZallDataAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass()))) {
            ...
            if (viewNode != null) {
                if (!TextUtils.isEmpty(viewNode.getViewPath())) {
                    if ((ZallDataAPI.sharedInstance().isVisualizedAutoTrackEnabled() && ZallDataAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass()))
                            || (ZallDataAPI.sharedInstance().isHeatMapEnabled() && ZallDataAPI.sharedInstance().isHeatMapActivity(activity.getClass()))) {
