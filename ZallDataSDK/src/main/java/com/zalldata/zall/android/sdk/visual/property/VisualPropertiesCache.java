...
import com.zalldata.zall.android.sdk.data.persistent.PersistentVisualConfig;
...
public class VisualPropertiesCache {
    ...
    private static final String TAG = "ZA.VP.VisualPropertiesCache";
    ...
    public void save2Cache(String config) {
        ZALog.i(TAG, "save2Cache config is:" + config);
    ...
    public VisualConfig getVisualConfig() {
        ...
        ZALog.i(TAG, "local visual config is :" + persistentVisualConfig);
