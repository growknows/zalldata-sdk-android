...
public class ViewTreeStatusObservable implements OnGlobalLayoutListener, OnScrollChangedListener, OnGlobalFocusChangeListener {
    private static final String TAG = "ZA.ViewTreeStatusObservable";
    ...
    class TraverseRunnable implements Runnable {
        ...
        public void run() {
            ZALog.i(TAG, "start traverse...");
            traverseNode();
            ZALog.i(TAG, "stop traverse...");
        }
    }

    public void onGlobalFocusChanged(View oldFocus, View newFocus) {
        ZALog.i(TAG, "onGlobalFocusChanged");
        traverse();
    }

    public void onGlobalLayout() {
        ZALog.i(TAG, "onGlobalLayout");
        traverse();
    }

    public void onScrollChanged() {
        ZALog.i(TAG, "onScrollChanged");
        traverse();
    }
