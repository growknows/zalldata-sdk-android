...
import com.zalldata.zall.android.sdk.visual.property.VisualPropertiesLog;
...
public class VisualizedAutoTrackService {
    private static final String TAG = "ZA.VisualizedAutoTrackService";
        ...
        try {
            if (mVisualDebugHelper != null) {
                ...
                if (!TextUtils.isEmpty(mLastDebugInfo)) {
                    ZALog.i(TAG, "visual debug info: " + mLastDebugInfo);
    ...
    String getLastDebugInfo() {
        try {
            if (!TextUtils.isEmpty(mLastDebugInfo)) {
                ZALog.i(TAG, "last debug info: " + mLastDebugInfo);
                return mLastDebugInfo;
            }
        } catch (Exception e) {
            ZALog.printStackTrace(e);
        ...
        try {
            if (mVisualPropertiesLog != null) {
                ...
                if (!TextUtils.isEmpty(visualPropertiesLog)) {
                    ZALog.i(TAG, "visual log info: " + visualPropertiesLog);
