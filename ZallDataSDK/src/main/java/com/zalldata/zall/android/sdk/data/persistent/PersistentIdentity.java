...
package com.zalldata.zall.android.sdk.data.persistent;
...
public abstract class PersistentIdentity<T> {
    ...
    private static final String TAG = "ZA.PersistentIdentity";
        ...
        if (this.item == null) {
            ...
            synchronized (loadStoredPreferences) {
                try {
                    ...
                    ZALog.d(TAG, "Cannot read distinct ids from sharedPreferences.", e.getCause());
                } catch (final InterruptedException e) {
                    ZALog.d(TAG, "Cannot read distinct ids from sharedPreferences.", e);
                }
