...
public class ZADataHelper {
    ...
    private static final String TAG = "ZA.ZADataHelper";
    private static final String[] WHITE_LIST = {"zalldata_app_visual_properties"};
    ...
    public static String assertPropertyLength(String property) {
        if (property != null && property.length() > 8191) {
            ...
            ZALog.d(TAG, "The property value is too long. property=" + property);
        }
        return property;
    }
