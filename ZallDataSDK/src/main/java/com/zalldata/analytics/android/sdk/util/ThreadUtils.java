...
public class ThreadUtils {
    private static final String TAG = "ZA.ThreadUtils";
    ...
    static final class ThreadPoolExecutorUtil extends ThreadPoolExecutor {
        ...
        public void execute(Runnable command) {
            ...
            try {
                ...
                ZALog.i(TAG, "This will not happen!");
            ...
            Thread t = new Thread(r, namePrefix + getAndIncrement()) {
                ...
                public void run() {
                    try {
                        ...
                        ZALog.i("ThreadUtils", "Request threw uncaught throwable");
                    }
                }
            };
