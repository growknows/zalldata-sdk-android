...
public class ZASpUtils {
    private static final String TAG = "ZA.ZASpUtils";
    ...
    public static SharedPreferences getSharedPreferences(Context context, String name, int mode) {
        if (mSharedPreferencesProvider != null) {
            ...
            if (userDefault != null) {
                ZALog.d(TAG, "create SharedPreferences by user default, file name is: " + name);
                return userDefault;
            }
        }
