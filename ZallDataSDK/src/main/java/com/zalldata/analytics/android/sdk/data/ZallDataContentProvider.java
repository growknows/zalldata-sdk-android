...
public class ZallDataContentProvider extends ContentProvider {
    private static final UriMatcher uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
    private ZallDataDBHelper dbHelper;
    private ZAProviderHelper mProviderHelper;
        ...
        try {
            ...
            if (context != null) {
                ...
                try {
                    ...
                    packageName = "com.zalldata.analytics.android.sdk.test";
                }
                dbHelper = new ZallDataDBHelper(context);
                mProviderHelper = new ZAProviderHelper(context, dbHelper);
                mProviderHelper.appendUri(uriMatcher, packageName + ".ZallDataContentProvider");
                /* 迁移数据，并删除老的数据库 */
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        try {
            ...
            if (ZAProviderHelper.URI_CODE.EVENTS == code) {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            int code = uriMatcher.match(uri);
            if (code == ZAProviderHelper.URI_CODE.EVENTS) {
                return mProviderHelper.insertEvent(uri, values);
            } else if (code == ZAProviderHelper.URI_CODE.CHANNEL_PERSISTENT) {
