...
public class OaidHelper {
    private static final String TAG = "ZA.DeviceUtils";
    // OAID
    ...
    public static String getOAID(final Context context) {
        ...
        ZALog.i(TAG, "romOAID is " + romOAID);
    ...
    private static String getRomOAID(final Context context) {
        try {
            ...
            ZALog.d(TAG, "CountDownLatch await");
            return mOAID;
        } catch (Throwable ex) {
    ...
    private static void getOAIDReflect(Context context, int retryCount) {
        try {
            ...
            ZALog.d(TAG, "MdidSdkHelper ErrorCode : " + errCode);
    ...
    private static String loadPemFromAssetFile(Context context) {
        try {
            ...
            ZALog.d(TAG, "loadPemFromAssetFile failed");
            return "";
        }
    }
