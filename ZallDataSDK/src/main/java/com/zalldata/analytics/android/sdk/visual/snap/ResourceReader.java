...
public abstract class ResourceReader implements ResourceIds {
    ...
    private static final String TAG = "ZA.ResourceReader";
    ...
    private static void readClassIds(Class<?> platformIdClass, String namespace,
        ...
        try {
            ...
            ZALog.i(TAG, "Can't read built-in id names from " + platformIdClass.getName(), e);
        }
    }
    ...
    protected void initialize() {
        ...
        try {
            ...
            ZALog.i(TAG, "Can't load names for Android view ids from '" + localClassName
