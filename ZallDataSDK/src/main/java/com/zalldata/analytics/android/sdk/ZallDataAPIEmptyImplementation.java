...
public class ZallDataAPIEmptyImplementation extends ZallDataAPI {
    ZallDataAPIEmptyImplementation() {
    ...
    @Override
    public void disableAutoTrack(ZallDataAPI.AutoTrackEventType autoTrackEventType) {
    ...
    @Override
    public boolean isAutoTrackEventTypeIgnored(ZallDataAPI.AutoTrackEventType eventType) {
        return true;
    }
    ...
    @Override
    public void addZAJSListener(ZAJSListener listener) {
