...
public class ZallDataLoadingDialog extends Dialog {

    private RelativeLayout mLoadingLayout;

    public ZallDataLoadingDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (window != null) {
            ...
            p.height = ZADisplayUtil.dip2px(getContext(), 98);
            p.width = ZADisplayUtil.dip2px(getContext(), 88);
