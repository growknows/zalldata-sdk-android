...
package com.zalldata.analytics.android.sdk.visual.bridge;
...
public class JSBridgeHelper implements WebViewJavascriptBridge {
    ...
    private ZAJSListener mZAJSListener;

    public void addZAJSListener() {
        if (mZAJSListener == null) {
            mZAJSListener = new ZAJSListener() {
                @Override
            ...
            ZallDataAPI.sharedInstance().addZAJSListener(mZAJSListener);
        }
    }
    ...
    public synchronized void sendToWeb(final View webView, final String methodName, Object data, OnBridgeCallback responseCallback) {
        try {
            ...
            if (data instanceof String) {
                ...
                ZallDataUtils.mergeJSONObject((JSONObject) data, object);
            }
            ...
            if (webView != null) {
                webView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        invokeWebViewLoad(webView, "loadUrl", new Object[]{"javascript:window.zalldata_app_call_js(" + result + ")"}, new Class[]{String.class});
                    }
                });
            }
        } catch (Exception e) {
