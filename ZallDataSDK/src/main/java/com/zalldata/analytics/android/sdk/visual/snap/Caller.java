...
package com.zalldata.analytics.android.sdk.visual.snap;
...
public class Caller {
    ...
    private static final String TAG = "ZA.Caller";
    ...
    public Object applyMethodWithArguments(View target, Object[] arguments) {
        ...
        if (mTargetClass.isAssignableFrom(klass)) {
            try {
                ...
                ZALog.i(TAG, "Method " + mTargetMethod.getName() + " appears not to be public", e);
            } catch (final IllegalArgumentException e) {
                ZALog.i(TAG,
                        "Method " + mTargetMethod.getName() + " called with arguments of the wrong type", e);
            } catch (final InvocationTargetException e) {
                ZALog.i(TAG, "Method " + mTargetMethod.getName() + " threw an exception", e);
            }
        }
