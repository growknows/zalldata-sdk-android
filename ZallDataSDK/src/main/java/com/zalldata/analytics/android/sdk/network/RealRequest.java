...
package com.zalldata.analytics.android.sdk.network;
...
class RealRequest {
    ...
    private static final String TAG = "ZA.HttpRequest";
    ...
    RealResponse getData(String requestURL, Map<String, String> headerMap) {
        try {
            ZALog.i(TAG, String.format("url:%s,\nmethod:GET", requestURL));
