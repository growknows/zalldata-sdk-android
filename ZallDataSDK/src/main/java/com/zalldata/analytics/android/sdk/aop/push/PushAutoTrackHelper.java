...
package com.zalldata.analytics.android.sdk.aop.push;
...
import com.zalldata.analytics.android.sdk.ZallDataAPIEmptyImplementation;
...
public class PushAutoTrackHelper {
    ...
    private static final String TAG = "ZA.PushAutoTrackHelper";
    ...
    public static void trackJPushOpenActivity(Intent intent) {
        ...
        ZALog.i(TAG, "trackJPushOpenActivity is called, Intent data is " + data);
        ...
        try {
            ...
            try {
                ...
                ZALog.i(TAG, "Failed to construct JSON");
            }
            if (jsonObject != null) {
                ...
                ZALog.i(TAG, String.format("trackJPushOpenActivity is called, title is %s, content is %s," +
    ...
    private static void trackNotificationOpenedEvent(String sfData,
        ...
        try {
            if (isRepeatEvent()) {
                ZALog.i(TAG, String.format("$AppPushClick Repeat trigger, title is %s, content is %s," +
            ...
            ZallDataAPI.sharedInstance().track("$AppPushClick", eventProperties);
        } catch (Exception e) {
            ZALog.printStackTrace(e);
        }
    }
    ...
    private static boolean isRepeatEvent() {
        ...
        ZALog.i(TAG, "currentTime: " + currentTime + ",lastPushClickTime: " + lastPushClickTime);
    ...
    public static void trackJPushAppOpenNotification(String extras,
        ...
        ZALog.i(TAG, String.format("trackJPushAppOpenNotification is called, title is %s, content is %s," +
    ...
    public static void trackMeizuAppOpenNotification(String extras,
        ...
        ZALog.i(TAG, String.format("trackMeizuAppOpenNotification is called, title is %s, content is %s," +
    ...
    public static void onGeTuiNotificationClicked(Object gtNotificationMessage) {
        if (gtNotificationMessage == null) {
            ZALog.i(TAG, "gtNotificationMessage is null");
            return;
        }
        if (!isTrackPushEnabled()) return;
        try {
    ...
    public static void onUMengNotificationClick(Object UMessage) {
        ...
        try {
            ...
            if (raw == null) {
                ZALog.i(TAG, "onUMengNotificationClick:raw is null");
                return;
            }
            ...
            if (body != null) {
                ...
                ZALog.i(TAG, String.format("onUMengNotificationClick is called, title is %s, content is %s," +
        ...
        try {
            ...
            if (!TextUtils.isEmpty(intentBody)) {
                ...
                if (body != null) {
                    ...
                    ZALog.i(TAG, String.format("onUMengActivityMessage is called, title is %s, content is %s," +
                            " extras is %s", title, content, extra));
                }
            }
        } catch (Exception e) {
    ...
    private static void onBroadcastServiceIntent(Intent intent) {
        ...
        try {
            ...
            ZALog.i(TAG, "onBroadcastServiceIntent");
        } catch (Exception e) {
            ZALog.printStackTrace(e);
        }
    }
    ...
    private static boolean isTrackPushEnabled() {
        try {
            if ((ZallDataAPI.sharedInstance() instanceof ZallDataAPIEmptyImplementation) ||
                    ZallDataAPI.getConfigOptions() == null ||
                    !ZallDataAPI.getConfigOptions().mEnableTrackPush) {
                ZALog.i(TAG, "SDK or push disabled.");
                return false;
            }
            return true;
        } catch (Exception e) {
    ...
    private static String getSFData(String extras) {
        ...
        try {
            ...
            ZALog.i(TAG, "get sf_data failed");
        }
        return sfData;
    }
}
