...
import com.zalldata.analytics.android.demo.widget.AAWebView
import com.zalldata.analytics.android.demo.widget.AAX5WebView
import com.zalldata.analytics.android.demo.widget.AWebView
import com.zalldata.analytics.android.demo.widget.AX5WebView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        x5WebView.webChromeClient = object : WebChromeClient() {
            ...
            override fun onProgressChanged(view: WebView, newProgress: Int) {
                ...
                ZALog.i(TAG, "current progress: $newProgress")
            }
        }
...
//        }
        //ZallDataAPI.sharedInstance().showUpX5WebView(x5WebView, true)


        //ZallDataAPI.sharedInstance().showUpWebView(androidWebView, true,true)
