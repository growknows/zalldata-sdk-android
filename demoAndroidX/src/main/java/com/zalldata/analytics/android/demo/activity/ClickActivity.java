...
import com.zalldata.analytics.android.demo.databinding.ActivityClickBinding;
import com.zalldata.analytics.android.demo.entity.BindingEntity;
...
public class ClickActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void type9() {
        ...
        ZallDataAPI.sharedInstance().ignoreView(textView);
