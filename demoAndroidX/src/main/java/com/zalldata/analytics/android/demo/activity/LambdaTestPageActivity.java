...
public class LambdaTestPageActivity extends AppCompatActivity {
    ...
    private void handleExpandableListView() {
        ...
        final String[][] childs = new String[][]{{"Zall Analytics", "Zall Focus", "Zall Personas", "Zall Recommender", "Zall Journey"}, {"Zall Data Governor", "Zall Point", "Zall Personalization Engine",
