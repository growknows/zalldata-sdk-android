...
import com.zalldata.analytics.android.demo.utils.SPUtils;
...
public class H5VisualTestActivity extends BaseActivity {
    ...
    private static String ZA_KEY_WEBVIEW_URL = "ZA_KEY_WEBVIEW_URL";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWebView.loadUrl((String) SPUtils.getInstance().getParam(ZA_KEY_WEBVIEW_URL, mItems.get(0)));
    }
    ...
    private void handlerClick(String url) {
        ...
        if (!TextUtils.equals(url, mWebView.getUrl())) {
            ...
            SPUtils.getInstance().saveParam(ZA_KEY_WEBVIEW_URL, url);
